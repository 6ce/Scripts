...
getgenv().MagnetGUIToggled = false
-- // Variables
...
local library = {
    ...
    folders = {
        main = "magnet",
        assets = "magnet/assets",
        configs = "magnet/configs"
    },
    shared = {
        initialized = false,
        fps = 0,
...
do
    ...
    function utility:GetRandomSubtitle()
       local possibleSubtitles = {"Haiiiii ^_^", "Heyyyy >_<", "lukejdjd is a fat pig", "6cce is a literal MEME", "dont play eau kids its ass", "m1v the goat?"}
       
       return possibleSubtitles[math.random(1, #possibleSubtitles)]
    end
    --
    ...
    function library:New(info)
        ...
        function window:Unload()
            ...
            for i,v in next, library.hidden do
				if v[1] and v[1].Remove ~= nil then
					local instance = v[1]
					v[1] = nil
					v = nil
					instance:Remove()
        ...
        function window:Fade()
			window.fading = true
			MagnetGUIToggled = not MagnetGUIToggled
            local NewTransparency = MagnetGUIToggled == true and 1 or 0
            
            window.isVisible = MagnetGUIToggled
            
            for i,v in next, window.drawings do
            	utility:Lerp(v[1], {Transparency = NewTransparency}, 0.25)
			end
